...
namespace DAL.Modules
{
    public class DBHelper
    {
        ...
        {
            return @"Data Source=DESKTOP-GUE0JS7;Initial Catalog=DM;Integrated Security=True";
        }
        ...
        public DataSet GetDataSet(SqlDataAdapter sqlDataAdapter, string tableName)
        {
            DataSet dt = new DataSet();
            return sqlDataAdapter.Fill(dt, tableName) != 0 ? dt : null;
        }
        public DataSet GetDataSet(string selectCommandText, string tableName)
        {
            DataSet dt = new DataSet();
            GetAdapter(selectCommandText).Fill(dt, tableName);
            return dt;
        }
        #endregion
    }
